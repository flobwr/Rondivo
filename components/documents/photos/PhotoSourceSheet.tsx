...
// Same bottom-sheet chrome as the rest of the Documents module — the source
// picker shown after choosing which phase a new photo belongs to.
export function PhotoSourceSheet({ visible, onClose, onPickCamera, onPickLibrary }: Props) {
