...
function PlusRow({ id, subtitle, onPress }: { id: PlusItemId; subtitle?: string; onPress: () => void }) {
      ...
      <View style={styles.card}>
        {items.map((id, index) => (
          <View key={id}>
            ...
            <PlusRow id={id} subtitle={subtitles?.[id] ?? PLUS_ITEMS[id].subtitle} onPress={() => onItemPress(id)} />
          </View>
        ))}
      </View>
    </View>
